...
public:
	...
	_bool			Find_Cross(const char* pFileName);
	_bool			FInd_Conveyor(const char* pFileName);
	_bool			FInd_ConveyorCorner(const char* pFileName);
	_bool			FInd_Glass(const char* pFileName);
