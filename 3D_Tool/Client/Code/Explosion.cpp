...
HRESULT CExplosion::Add_Component(void)
{
	...
	pComponent = m_pTextureCom = dynamic_cast<Engine::CTexture*>(Engine::Clone(RESOURCE_STAGE, L"Texture_Explosion"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
HRESULT CExplosion::SetUp_ConstantTable(LPD3DXEFFECT& Effect)
{
