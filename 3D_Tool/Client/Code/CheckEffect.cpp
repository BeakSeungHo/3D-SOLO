...
CCheckEffect::CCheckEffect(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CGameObject(pGraphicDev)
{

}

CCheckEffect::~CCheckEffect(void)
{

}

HRESULT CCheckEffect::Ready_GameObject(void)
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);

	m_pTransformCom->Set_Scale(2.f,0.8f,2.f);
...
_int CCheckEffect::Update_GameObject(const _float& fTimeDelta)
{
...
void CCheckEffect::Render_GameObject(void)
{
...
HRESULT CCheckEffect::Add_Component(void)
{
	...
	pComponent = m_pTextureCom = dynamic_cast<Engine::CTexture*>(Engine::Clone(RESOURCE_STAGE, L"Texture_CheckPoint"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
HRESULT CCheckEffect::SetUp_ConstantTable(LPD3DXEFFECT& Effect)
{
...
CCheckEffect* CCheckEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CCheckEffect*	pInstance = new CCheckEffect(pGraphicDev);
