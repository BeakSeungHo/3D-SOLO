...
void Engine::CRenderTargetMgr::SetUp_OnShader(LPD3DXEFFECT& pEffect, const _tchar* pTargetTag, const char* pContantName)
{
	CRenderTarget*		pRenderTarget = Find_RenderTarget(pTargetTag);
...
Engine::CRenderTarget* Engine::CRenderTargetMgr::Find_RenderTarget(const _tchar* pTargetTag)
{
